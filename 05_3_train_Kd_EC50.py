...
from evaluate import evaluate_CPA, save_result_CPA
...
def run(model, optimizer, train_loader, valid_loader, test_loader, dataset):
    ...
    model_path = './save_model/valid_best_checkpoint.pth'
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if res_valid[1] > valid_max_PCC:
            ...
            decline = 0
            # save_path = './save_model/{}/{}_valid_best_checkpoint{}.pth'.format(dataset, args.substructure, epoch)
...
if __name__ == '__main__':
    ####################################################
    # Kd and EC50: lr:1e-3, lr_step_size:10, epochs:70 #
    ####################################################
